...
"""
from src.res.Array.pivot_index import input as ip, output as op
...
def solve():
    ...
    for arr in input:
        results.append(pivot_index_optimised(arr))
    print(results)
...
def pivot_index_optimised(nums: List[int]) -> int:
    n = len(nums)
